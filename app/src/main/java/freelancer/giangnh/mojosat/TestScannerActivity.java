...
public class TestScannerActivity extends Activity implements ZXingScannerView.ResultHandler {
    private final static String TAG = TestScannerActivity.class.getSimpleName();
